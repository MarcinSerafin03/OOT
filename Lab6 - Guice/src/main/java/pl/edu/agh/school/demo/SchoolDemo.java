...
public class SchoolDemo {
    ...
    public void initClass(Injector injector) throws ParseException {
        if (school.findClass("1A", "humane").isEmpty()) {
            ...
            Subject subject;
            subject = new Subject(logger,"Math");
            ...
            subject = new Subject(logger,"English");
            subject.addTerm(new Term(DayOfWeek.MONDAY, timeFormat
                    .parse("12:00"), 45));
            ...
            subject = new Subject(logger,"Computer Science");
            subject.addTerm(new Term(DayOfWeek.TUESDAY, timeFormat
                    .parse("09:00"), 45));
            subject.setTeacher((Teacher) school
                    .findPerson("Thomas", "Anderson").iterator().next());
            ...
            subject = new Subject(logger,"Chemistry");
            subject.addTerm(new Term(DayOfWeek.WEDNESDAY, timeFormat
                    .parse("11:30"), 45));
            ...
            subject = new Subject(logger,"Potions");
            ...
            subject = new Subject(logger,"Black Magic Defense");
            subject.addTerm(new Term(DayOfWeek.FRIDAY, timeFormat
                    .parse("12:30"), 90));
